...
uint8_t     page        = 0;
char        dir         = 'S';
uint32_t    dir_timer   = 0;
uint16_t    distance    = 0;//dm 

uint8_t     rx_buff[20] = {0};
uint8_t     rx_single[1]= {0};
/* USER CODE END PV */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    HAL_UART_Receive_DMA(&huart1, rx_single, 1);
  /* USER CODE END 2 */
